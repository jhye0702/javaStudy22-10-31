...
public class Ch24_04 {
	...
	public static void main(String[] args) {
		...
		// 두개의 파라미터를 필요로 하며 첫 번째 파라미터는 바꿔야할 항목, 두번째 파라미터는 바꿀 값을 대입.
		// set(바꿔야할 항목, 바꿀 값);
		// set(년, 월, 일);
		...
		long diff = endOfYear.getTimeInMillis() - today.getTimeInMillis(); // 연말에서 현재까지의 초를 뺌
		System.out.println("연말까지 남은 날 : " + diff / (24 * 60 * 60 * 1000) + "일"); 
		// 하루 24시간, 시간당 60분, 분당 60초, 1초를 1000으로 ........!!!
		// 연말에서 현재까지의 초를 일로 변환
