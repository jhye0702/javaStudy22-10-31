...
public class Ch24_10_java_time_package {
	...
	public static void main(String[] args) {
		 ...
		 * 2) 특정날짜를 지정하는 of() 메서드를 사용하는 방법이 있음.
		 */
		
		// 날짜를 더하고 빼는 메서드를 확인하는 코드
		// minusYears(long) 년도 빼기, minusMonth(long) 월 빼기, minusDays(long) 일 빼기, minusWeeks(long) 주 빼기
		...
		// 자동변환
		LocalDate ld3 = ld.minusDays(3);	// ld2 에서 3일을 뺌
		System.out.println(ld3); 			// 2022-12-13
		
		// 주 더하기
		LocalDate ld4 = ld3.plusWeeks(3); 	// ld3에서 3주를 더함
		System.out.println(ld4);			//2023-01-03
	}
