...
public class Ch16_15_String {
	public static void main(String[] args) {
		/*
		 ...
		 2) 문자열 상수를 가리키는 방식
		 String str3 = "abc";
		 생성자를 이용하지 않고 바로 문자열 상수를 가리키는 경우에는 
		 기존에 만들어져 있던 문자열 상수의 메모리 값을 가리키게 됨.
		...
		System.out.println(str1 == str2);		// false. 인스턴스가 매번 새로 생성되므로 
												//		   str1과 str2는 주소값이 다름
		...
		System.out.println(str3 == str4);		// true. 문자열 abc는 상수 풀에 저장되어 있으므로 
												//		 str3과 str4 가 가리키는 주소값이 같음.
