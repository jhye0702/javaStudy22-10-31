...
public class Ch16_04_booleanEquals {
	...
	public static void main(String[] args) {
		...
		String comp1 = new String("비교1");
		String comp2 = new String("비교2");
		
		System.out.println(comp1 == comp2); // false. 두 스트링 인스턴스의 주소 값은 다름
		...
		System.out.println(str1 == str2); 		// false. 두 정수 인스턴스의 주소 값은 다름
		System.out.println(str1.equals(str2)); 	// true. Integer 클래스의 equals 메소드가 재정의 됨.
