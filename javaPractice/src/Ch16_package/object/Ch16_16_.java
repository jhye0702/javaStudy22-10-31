...
public class Ch16_16_ {
	...
	public static void main(String[] args) {
		/* 다른 프로그래밍 언어는 문자열을 구현할 때 char[] 배열을 사용
		   ...
		   프로그램에서 두 개의 문자열을 연결하면, 둘 중 하나의 문자열이 변경되는게 아니라 
		   두 문자열이 연결된 새로운 문자열이 생성.
		 */
		
		String javaStr = new String ("java");
		String androidStr = new String("android");
		System.out.println(javaStr); // java
		System.out.println("처음 문자열 주소 값: " + System.identityHashCode(javaStr)); // 처음 문자열 주소값: 474675244
		
		javaStr = javaStr.concat(androidStr); // java와 android 문자열의 연결
		
		System.out.println(javaStr); //javaandroid
		System.out.println("연결된 문자열 주소 값: " + System.identityHashCode(javaStr)); // 연결된 문자열 주소값: 932583850
		
		// 문자열의 값을 변경하는 경우.
//		javaStr = "new java";
//		System.out.println(javaStr); // new java
//		System.out.println("값을 변경한 문자열 주소 값: " + System.identityHashCode(javaStr)); //값을 변경한 문자열 주소 값: 212628335
	}
