...
//	생성자의 접근 제어자가 private이므로 외부 클레스에서 마음 대로 Company인스턴스를 생성할 수 없음.
...
//	인스턴스를 반환하는 메서드는 반드시 static으로 선언해야함.
//	getInstance()메서드는 인스턴스 생성과 상관 없이 호출할 수 있어야 하기 때문
...
public class Ch19_02_singleton {
